...
public extension ComposeContent {
    ...
    func asVStack(alignment: ComposeLayout.HorizontalAlignment = .center) -> any ComposeNode {
        let nodes = asNodes()
        switch nodes.count {
        case 0:
            return EmptyNode()
    ...
    func asZStack(alignment: ComposeLayout.Alignment = .center) -> any ComposeNode {
        let nodes = asNodes()
        switch nodes.count {
        case 0:
            return EmptyNode()
