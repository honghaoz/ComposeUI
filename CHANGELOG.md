...
- A child view rendered by `ComposeViewNode` never runs more transitions or animations than the parent's render pass allows, whatever its own `animationBehavior`.
